...
Please, if you want to see the full documentation for this project, open it in the docs package - [index.html](https://github.com/MilaEgoshina/pet-registry-system/blob/main/docs/index.html) file.
